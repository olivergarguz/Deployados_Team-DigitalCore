...
export default function DiscordDesvinculado() {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-[110] animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl p-8 w-full max-w-sm shadow-xl text-center animate-in zoom-in-95 duration-200">
        ...
        <button
          onClick={() => router.push("/")}
          className="w-full px-4 py-2 rounded-lg bg-indigo-500 text-white text-sm font-semibold hover:bg-indigo-600 shadow-md shadow-indigo-200 transition-colors"
        >
          Ir al inicio
        </button>
